...
export default function Hero() {
  return (
    <section className="min-h-screen grid md:grid-cols-2 gap-20 items-center px-8 md:px-16 pt-32 md:pt-0" id="home">
      <motion.div
      ...
      <motion.div
        ...
        className="hidden md:block w-full h-[600px] bg-gradient-to-br from-burgundy to-midnight-black rounded"
      >
        {/* Add your image here */}
